...
let CharactersRepository = class CharactersRepository extends typeorm_1.Repository {
    findAll(limit) {
        return this.createQueryBuilder('characters')
            .offset(limit[0])
            .take(limit[1])
            .getMany();
    }
...
CharactersRepository = __decorate([
    (0, typeorm_1.EntityRepository)(characters_1.Characters)
